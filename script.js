const usInfluencersData = [
    {
        ...
        style: "堅定看多",
        viewpoint: "【2026.06 週二盤前更新】亞股大爆發帶動美股期指，週一大盤洗出長下影線，顯示市場多空交戰激烈。雖然強勁就業數據引發降息預期落空與科技股重挫，但這完全符合我預測的「2026年三階段」短期陣痛期。短線回檔只是牛市中的正常顛簸，並未改變基本面。我依然維持標普500年底上看7,700點的目標。這波拋售反而為長線投資者提供了絕佳的佈局良機，不必因一時的震盪而恐慌。",
        stocks: ["IWM (羅素2000)", "QQQ (納斯達克100)", "SPY (標普500)"],
        entryPoint: "【週三操作】台股狂飆千點確認底部，美股期指偏多。持股續抱，空手者不宜再追高，等待 CPI 震盪時再行佈局。"
    },
    {
        name: "Mike Wilson (Morgan Stanley)",
        style: "務實轉多",
        viewpoint: "【2026.06 週二盤前更新】亞股大爆發帶動美股期指，週一大盤洗出長下影線，顯示市場多空交戰激烈。這次由就業數據超預期引發的「好消息就是壞消息」市場修正，是利率預期重估的必然結果。然而，我們近期才將標普500目標價上調至8,300點。人工智慧的資本支出與企業獲利增長才是真正的長期驅動力。這次科技股的估值修正，正好消化了過熱的市場情緒，未來的本益比擴張將成為今年最大驚喜。",
        stocks: ["MSFT (微軟)", "AAPL (蘋果)", "GOOGL (Alphabet)"],
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，關注具有實質AI獲利能力的大型優質股，在估值合理時逐步建倉。"
    },
    {
        name: "Bill Ackman (Pershing Square)",
        style: "價值成長",
        viewpoint: "【2026.06 週二盤前更新】亞股（如台股）今日瘋狂大漲千點，完全帶動了美股期指的樂觀情緒！週一的長下影線正式確認大戶洗盤結束。但請注意，週三即將迎來關鍵的 CPI 與 FOMC 會議，這波報復性反彈將面臨通膨數據的壓力測試。",
        stocks: ["MSFT (微軟)", "META (Meta)", "AMZN (亞馬遜)"],
        entryPoint: "【週三操作】強勁反彈可能只是死貓反彈 (Dead-cat bounce)，CPI 與 FOMC 決策前夕切勿興奮追價，趁反彈適度獲利了結。"
    },
    {
        ...
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，透過黃金與國債等避險資產進行多元化配置，以防範流動性危機與結構性風險。"
    },
    {
        ...
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，保持高度敏銳的宏觀視角，適度降低槓桿並聚焦於具備長期稀缺性的優質資產。"
    },
    {
        name: "Adam Kobeissi",
        style: "數據波段",
        viewpoint: "【2026.06 週二盤前更新】亞股大爆發帶動美股期指，週一大盤洗出長下影線，顯示市場多空交戰激烈。市場將這次大跌稱為「崩盤」是過度反應了。根據我們的「六層蛋糕」AI基礎設施框架分析，這只是一次從AI半導體領頭羊向優質藍籌股的正常資金輪動。AI交易只是暫時喘息，這類5%至10%的溫和回撤，反而為市場提供了健康的消化空間。強勁的就業數據顯示經濟底氣仍在，這明確是一個買入機會。",
        stocks: ["TSMC (台積電)", "AMD (超微)", "AVGO (博通)"],
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，視5-10%的市場回調為買入良機，重點佈局AI產業鏈中被錯殺的核心基礎設施股。"
    },
    {
        name: "Jensen Huang (黃仁勳)",
        style: "供應鏈狂人",
        viewpoint: "【2026.06 週二盤前更新】亞股大爆發帶動美股期指，週一大盤洗出長下影線，顯示市場多空交戰激烈。儘管6月5日因Broadcom財測與高就業數據引發科技股暴跌，輝達單日重挫逾6%，但這不影響AI的長線需求。我正在台韓穩固供應鏈，已確認下半年產能翻倍。短期修正僅是情緒波動，AI基建剛性需求不變，我們將加速推進。",
        stocks: ["NVDA", "TSM", "ARM"],
        entryPoint: "【週三操作】台股狂飆千點確認底部，美股期指偏多。持股續抱，空手者不宜再追高，等待 CPI 震盪時再行佈局。"
    },
    {
        ...
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，無視短期總經數據干擾，專注投資具有壟斷性技術與顛覆性未來的硬核科技公司。"
    },
    {
        name: "Cathie Wood (ARK木頭姐)",
        style: "破壞性創新",
        viewpoint: "【2026.06 週二盤前更新】亞股大爆發帶動美股期指，週一大盤洗出長下影線，顯示市場多空交戰激烈。市場對就業數據產生嚴重誤判，將好消息視為壞消息。AI帶來的生產力爆發長期將抑制通膨。在6月5日的拋售中，ARK積極再平衡，減碼超漲的AMD，並大舉買進Pony AI與Kodiak AI。短期波動是逢低承接破壞性創新贏家的好時機。",
        stocks: ["COIN", "PONY", "KDK", "BEAM"],
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，趁市場錯殺成長股時積極調倉。加碼具備顛覆性技術且估值合理的創新領域。"
    },
    {
    ...
    },
    {
        ...
        style: "迷因價值派",
        viewpoint: "【2026.06 週二盤前更新】亞股大爆發帶動美股期指，週一大盤洗出長下影線，顯示市場多空交戰激烈。華爾街正為科技股暴跌哭天喊地，但我依舊神隱。雖然社群極度期待我能在 6 月 7 日兩週年回歸直播，但目前這僅是市場的猜測。不管那斯達克跌多慘，只要散戶團結一致堅持信仰，這波因我而起的波動就還沒結束。我的目光緊盯著 GameStop 等標的，我們能在混亂中找到屬於我們的深層價值。",
        stocks: ["GME", "CHWY", "KOSS"],
        entryPoint: "【週三操作】大戶在週一接走的籌碼今日已拉開成本，緊盯莊家 Gamma 值變化，若逼近極端值需提防軋空後的急速獲利了結。"
    },
    {
        ...
        viewpoint: "【2026.06 週二盤前更新】亞股（如台股）今日瘋狂大漲千點，完全帶動了美股期指的樂觀情緒！週一的長下影線正式確認大戶洗盤結束。但請注意，週三即將迎來關鍵的 CPI 與 FOMC 會議，這波報復性反彈將面臨通膨數據的壓力測試。",
        stocks: ["PG", "JNJ", "WM"],
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，避開未能達成高預期的AI概念股與高風險資產。立即將資金轉移至傳統防禦型價值股避險。"
    },
    {
        name: "美股小左",
        style: "第一視角",
    ...
    },
    {
        ...
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，關注宏觀流動性變化，將資金從純芯片硬體轉向具有實質應用落地的 AI 企業。"
    },
    {
        name: "美股研究社",
        style: "科技股基本面分析",
        viewpoint: "【2026.06 週二盤前更新】亞股大爆發帶動美股期指，美股週一盤中大震盪後，納斯達克與標普成功收紅！如同我們社群稍早的推演，AI 狂熱降溫帶來的只是「結構性修正」而非泡沫破裂。雲端巨頭（CSP）的資本支出並未縮減，短線跌深的優質半導體與軟體股已開始浮現長期投資價值。",
...
const twInfluencersData = [
    {
        name: "谷月涵",
        style: "防禦保守",
        viewpoint: "【2026.06 週二盤後更新】台股雖然報復性大漲千點，但成交量未能完全跟上，且外資期貨空單並未大幅回補。這可能只是跌深後的技術性反彈，本週真正的考驗是即將到來的聯準會 FOMC 會議與四巫日結算，切忌在此時追高。",
    ...
    },
    {
        name: "陸行之",
        style: "產業分析",
        viewpoint: "【2026.06 週二盤後更新】台股狂飆1200點，週一大盤洗出長下影線，顯示市場多空交戰激烈。這次股災是市場過熱後的必然修正，我先前就提醒過大家別太嗨。然而從產業基本面來看，半導體與AI供應鏈的長期成長動能依舊強勁，NVIDIA與台積電的競爭力未因暴跌而改變。投資人不應被外資目標價牽著走，這波殺盤洗清了浮額，現在正是檢視核心持股，專注於AI基礎設施的時刻。",
    ...
    },
    {
        name: "游庭皓",
        style: "景氣循環",
        viewpoint: "【2026.06 週二盤後更新】台股週二暴力狂飆 1,201 點，收復 44,000 大關！這完全印證了我們所說的『長下影線大戶抄底』理論。昨日敢於在恐慌中撿鑽石的投資人，今天已經豐收。但請注意，真正的主戰場在明晚的美國 CPI 數據發布。",
        stocks: ["0050 (元大台灣50)", "006208 (富邦台50)", "2330 (台積電)", "2382 (廣達)"],
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，運用景氣投資法，在市場恐慌急跌時分批佈局大盤市值型ETF與AI權值股。"
    },
    {
        name: "楊應超",
        style: "重視估值",
        viewpoint: "【2026.06 週二盤後更新】台股狂飆1200點，週一大盤洗出長下影線，顯示市場多空交戰激烈。台股崩跌印證了市場『完美定價』後的脆弱性。我先前已將持股降至三成以應對過熱風險。這次股災是估值的合理回歸，當股價脫離基本面，任何風吹草動都會引發震盪。投資人應重新計算合理股價，勿盲目抄底，維持股債平衡配置，鎖定具穩定現金流的科技龍頭，耐心等待安全邊際出現。",
        stocks: ["2330 (台積電)", "2308 (台達電)", "2412 (中華電)", "00679B (元大美債20年)"],
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，嚴守估值紀律與安全邊際，將資金平均配置於高殖利率優質股與避險美債。"
    },
    {
        name: "吳嘉隆",
        style: "總經趨勢",
    ...
    },
    {
        name: "胡睿涵 (非凡)",
        style: "價值投資",
        viewpoint: "【2026.06 週二盤後更新】台股狂飆1200點，週一大盤洗出長下影線，顯示市場多空交戰激烈。面對近期美股費半下挫引發的台指期夜盤狂瀉逾三千點，市場極度恐慌。但股市漲多必有技術修正，我們強調「跌時重質」，趁史詩級震盪正是檢視持股體質的好時機。巴菲特說別人恐懼你要貪婪，AI基本面未變，建議汰弱留強，資金轉往具備實質獲利的優質權值股，才能在風暴中持盈保泰。",
    ...
    },
    {
        name: "林漢偉 (非凡)",
        style: "資金輪動",
        viewpoint: "【2026.06 週二盤後更新】台股狂飆1200點，週一大盤洗出長下影線，顯示市場多空交戰激烈。台股從四萬六千點高檔回落，主要受美科技股財報影響，導致AI硬體股湧現獲利了結賣壓。這屬於漲多後的健康資金輪動，並非無差別崩盤。操作上切勿盲目追高殺低，應密切觀察五日線支撐與外資籌碼變化。建議避開漲幅過大的個股，尋找低檔轉強的機器人及矽光子概念股，防守兼備才能抓住機會。",
        stocks: ["1503 (士電)", "1519 (華城)", "2382 (廣達)", "3231 (緯創)"],
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，觀察大盤五日線支撐，拉回時布局低位階、有基本面護體的防守型個股。"
    },
    {
        name: "賴建承 (非凡)",
        style: "產業基本面",
    ...
    },
    {
        name: "李兆華 (東森)",
        style: "籌碼追蹤",
        viewpoint: "【2026.06 週二盤後更新】台股狂飆1200點，週一大盤洗出長下影線，顯示市場多空交戰激烈。台指期夜盤創下狂瀉三千點的最大跌點，市場恐慌蔓延。但歷史統計六七月上漲機率高，這次急跌主要是AI熱潮後的短線籌碼換手。請嚴控資金部位，避免情緒性追殺。重點觀察電子龍頭權值股是否止穩及美股止跌訊號。資金有望輪動到轉機題材的重電與散熱族群，保持冷靜才能在危機中看見選股機會。",
        stocks: ["3324 (雙鴻)", "3017 (奇鋐)", "2330 (台積電)", "1503 (士電)"],
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，嚴控資金水位，等待台積電等權值股止穩後，再介入散熱與重電轉機股。"
    },
    {
        name: "朱家泓 (東森)",
        style: "技術分析",
    ...
    },
    {
        ...
        viewpoint: "【2026.06 週二盤後更新】台股週二暴力狂飆 1,201 點，收復 44,000 大關！這完全印證了我們所說的『長下影線大戶抄底』理論。昨日敢於在恐慌中撿鑽石的投資人，今天已經豐收。但請注意，真正的主戰場在明晚的美國 CPI 數據發布。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "2317 (鴻海)", "2382 (廣達)"],
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，觀察半年線支撐與融資減肥，待權值股不再破底、爆量收下影線時再分批進場。"
    },
    {
        name: "郭哲榮 (折折)",
        style: "趨勢動能",
    ...
    },
    {
        ...
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，在 CPI 與聯準會態度明朗前，避免過度押注單一方向，留意美元與美債殖利率的波動指引。"
    },
    {
        name: "股癌 (Gooaye)",
        style: "主觀長期投資",
        ...
        entryPoint: "【週三操作】反彈行情延續，確認底部長下影線支撐，切忌跟著恐慌盲目砍在低點，應回歸『跌時重質』的原則，專注於基本面強健的龍頭股。"
    },
    {
