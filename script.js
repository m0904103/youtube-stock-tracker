const usInfluencersData = [
    ...
    },
    {
        ...
        viewpoint: "【2026.07.15 盤前最新】維持標普年底8000點及以太幣長線看多觀點，並有報導指出其參與以太幣隱私項目EthSystems。",
        stocks: ["IWM (羅素2000)", "QQQ (納斯達克100)", "SPY (標普500)"],
        entryPoint: "可關注加密貨幣板塊的機構採用與長線佈局機會。"
    },
    {
        ...
        viewpoint: "【2026.07.15 盤前最新】表示美股漲勢正擴大至科技巨頭外，經濟進入新擴張期，但提醒關注AI板塊外的擁擠交易風險。",
        stocks: ["MSFT (微軟 ~$410)", "AAPL (蘋果 ~$291)", "GOOGL (Alphabet)"],
        entryPoint: "可留意消費與運輸等非科技板塊的財報表現以尋找輪動機會。"
    },
    {
    ...
    },
    {
        ...
        viewpoint: "【2026.07.15 盤前最新】大舉買入Circle及SpaceX，並減持AMD；認為比特幣已進入築底階段，將恢復長期上升趨勢。",
        stocks: ["COIN", "PONY", "KDK", "BEAM"],
        entryPoint: "可關注其增持之加密貨幣及太空科技相關標的。"
    },
    {
    ...
    },
    {
        ...
        viewpoint: "【2026.07.15 盤前最新】重申對好市多(COST)的支持，將其視為情緒提振；近期也曾看好IBM在逆風中的表現。",
        stocks: ["PG", "JNJ", "WM"],
        entryPoint: "留意好市多與IBM等具備防禦性或轉機題材的大型股。"
    },
    {
        name: "美股小左",
        style: "第一視角",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.15 盤前最新】指出美股下跌受亞洲恐慌情緒傳染，但個股跌幅有限，大趨勢依然穩健，納指期貨已於盤前反彈。",
        stocks: ["NVDA (輝達)", "MSFT (微軟)", "AAPL (蘋果)"],
        entryPoint: "市場趨勢依然向上，不須因短期恐慌盲目殺跌。"
    },
  {
    name: "Alan Chen",
    style: "裸K與量價分析",
...
const twInfluencersData = [
    ...
    },
    {
        ...
        viewpoint: "【2026.07.15 盤後最新】建議放寬台股漲跌幅限制至15%或20%以活絡市場；長線樂觀看待AI革命，認為無須擔憂泡沫。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "2317 (鴻海)", "2603 (長榮)"],
        entryPoint: "關注交易制度潛在改革對市場波動的影響。"
    },
    {
        name: "杜金龍 (下班經濟學)",
        style: "波浪理論",
        ...
        viewpoint: "【2026.07.15 盤後最新】認為近期劇烈震盪是技術性休息，季線至4萬點有強勁支撐。建議趁拉回重新檢視基本面，點名南亞、台化等低基期股。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "2317 (鴻海)", "2408 (南亞科)"],
        entryPoint: "回檔就是買點，不宜盲目殺低，可分批佈局低基期或優質權值股。"
    },
    {
        name: "胡睿涵 (非凡)",
        style: "價值投資",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.15 盤後最新】分析AI伺服器與基礎設施需求，特別點出記憶體族群(如南亞科、威剛)受惠供應不足，具備多頭爆發潛力。",
        stocks: ["2408 (南亞科)", "2344 (華邦電)", "3260 (威剛)", "2376 (技嘉)"],
        entryPoint: "選股為王，建議佈局具成長潛力或低基期的產業龍頭並緊盯財報。"
    },
    {
        name: "李兆華 (東森)",
        style: "籌碼追蹤",
        ...
        viewpoint: "【2026.07.15 盤後最新】理財達人秀探討長下影線後盤勢，分析AI題材修正與法說會後表現；關注遭錯殺的軍工、CPO與半導體封測。",
        stocks: ["3324 (雙鴻)", "3017 (奇鋐)", "2330 (台積電)", "1503 (士電)"],
        entryPoint: "可留意遭市場錯殺的軍工、CPO及半導體封測族群之低接機會。"
    },
    {
        name: "朱家泓 (東森)",
        style: "技術分析",
        ...
        viewpoint: "【2026.07.15 盤後最新】強調技術線圖優先於基本面消息，以台塑化與南電等案例教學，應利用技術分析保護資金，等待多頭確認訊號。",
        stocks: ["2603 (長榮)", "2609 (陽明)", "2615 (萬海)"],
        entryPoint: "位階比方向重要，應嚴守技術面紀律與停損，避免追高殺低。"
    },
    {
        name: "股期龍哥 (東森)",
        style: "期現雙向",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.15 盤後最新】重點關注SEMI發布之半導體設備銷售創高預測，並全面聚焦16日台積電法說會與AI供應鏈展望。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "2317 (鴻海)", "2382 (廣達)"],
        entryPoint: "留意半導體設備族群及台積電法說會釋出的前瞻指引。"
    },
    {
        name: "郭哲榮 (折折)",
        style: "趨勢動能",
        ...
        viewpoint: "【2026.07.15 盤後最新】直播【台積法說明天定生死!】指出美國CPI降溫消除升息隱憂，帶動台股反彈。看好台積電先進製程獨大具漲價能力，未來獲利爆發力強。",
        stocks: ["2408 (南亞科)", "2344 (華邦電)", "3260 (威剛)", "2330 (台積電)"],
        entryPoint: "不追高，建議尋找如中美晶、微星等「低基期、有價有量」的個股。"
    },
    {
        name: "優課李霖",
        style: "數據轉折與循環",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.15 盤後最新】持續追蹤16日台積電法說會，關注AI晶片需求與先進製程漲價效應；點名矽晶圓與FO-PLP封裝技術迎來高速成長。",
        stocks: ["2382 (廣達)", "2317 (鴻海)", "2454 (聯發科)"],
        entryPoint: "聚焦台積電財報表現與先進封裝技術相關受惠股。"
    },
    {
    ...
    },
    {
        ...
        viewpoint: "【2026.07.15 盤後最新】認為近期因外部因素大跌是「假利空」，台灣處於AI革命核心基本面無虞，台股長線目標仍上看8萬點。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "MU (美光)", "2382 (廣達)"],
        entryPoint: "把握恐慌性下跌機會，低檔佈局具壟斷地位之績優權值股。"
    },
    {
        name: "阿村伯",
        style: "存股與生活",
        ...
        viewpoint: "【2026.07.15 盤後最新】指出台股受美股與CPI激勵強勁反彈；資金自大型AI股擴散至記憶體、PCB與塑化等族群，情緒顯著回溫。",
        stocks: ["2330 (台積電)", "0056 (元大高股息)", "2884 (玉山金)"],
        entryPoint: "留意資金輪動效應，可關注軍工與記憶體題材的操作機會。"
        }
];
