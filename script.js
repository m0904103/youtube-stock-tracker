const usInfluencersData = [
    ...
    },
    {
        ...
        style: "理性長線 / 帳戶實盤",
        viewpoint: "最新更新：發布了「6月必買3支股票」策略，並深度剖析 SpaceX 即將上市對特斯拉的連動影響。針對 NVDA 財報後給出低位加倉點位。",
        stocks: ["NVDA (輝達)", "TSLA (特斯拉)", "MU (美光)", "INTC (英特爾)", "PLTR (Palantir)"],
        entryPoint: "建議逢低佈局。具體買入價格與加倉點位通常在會員頻道展示，強調在波動中做好倉位控管。"
    },
    {
        name: "NaNa說美股",
        style: "幽默犀利 / 大眾視角",
        viewpoint: "【2026.06 最新覆核】以「小白語言」解構市場，近期吐槽舊科技巨頭與價值投資的窘境。認為市場展現韌性，資金正在板塊間快速輪動。",
    ...
    },
    {
        name: "游庭皓的財經皓角",
        style: "總體經濟 / 景氣循環",
        viewpoint: "【2026.06 最新覆核】探討 AI 行情是否為超級週期。分析台美韓印股市競合關係，以及半導體庫存循環對全球供應鏈的影響。",
    ...
    },
    {
        ...
        style: "科技大多頭 / 衍生受益者",
        viewpoint: "【2026.06 最新覆核】提出「AI 乘數效應」：Nvidia 硬體每投入1美元，將衍生出 8-10 美元的生態圈商機。市場已進入 AI 建設第二階段。",
...
const twInfluencersData = [
    {
        name: "獅公 (李永年)",
        style: "資深分析 / 總體指標",
        viewpoint: "【2026.06 最新覆核】對於高檔走勢表示審慎，提出「是最後加碼還是最後減碼？」的疑問，提醒密切關注油價、美元及資金流向。",
    ...
    },
    {
        name: "老王 (老王愛說笑)",
        style: "技術分析 / 嚴格紀律",
        viewpoint: "【2026.06 最新覆核】AI 供應鏈仍是多頭主旋律，但在萬點高位操作中，最看重「紀律」與「停損停利機制」。",
    ...
    },
    {
        name: "股癌 Gooaye (謝孟恭)",
        style: "產業趨勢 / 散戶指標",
        viewpoint: "【2026.06 最新覆核】台股資金正在進行板塊輪動，從漲多的硬體代工外溢尋找落後補漲標的。強烈警告融資開槓桿過熱，隨時有修正風險。",
    ...
    },
    {
        ...
        stocks: ["台積電 (2330)", "緯創 (3231)", "華邦電 (2344)", "辛耘 (3583)", "強茂 (2481)"],
    ...
    },
    {
        name: "谷月涵 (Peter Kurz)",
        style: "總經外資 / 大國博弈",
        viewpoint: "【2026.06 最新覆核】預警台美股市估值逼近極限。指出亞洲貨幣（日圓/人民幣）競貶壓力將是引爆全球資金洗牌的關鍵宏觀指標。",
    ...
    },
    {
        name: "陸行之",
        style: "半導體權威 / 產業戰略",
        viewpoint: "【2026.06 最新覆核】直指台積電赴美設廠的高成本隱憂與政治妥協。但同時高度肯定 AI 晶片的底層變革與長線霸權。",
    ...
    },
    {
        ...
        style: "算力造物主 / 絕對牽引力",
        viewpoint: "【2026.06 最新覆核】非證券分析師，但掌握台股估值天花板的絕對話語權。其所建構的 Agentic AI 生態系正引發台股資金的超級虹吸效應。",
