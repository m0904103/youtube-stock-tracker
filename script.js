const usInfluencersData = [
    ...
    },
    {
        ...
        viewpoint: "【2026.07.05 週末最新解析】趁跌加碼近10萬股特斯拉。木頭姐認為非農放緩非衰退訊號，而是官方數據失準；實際通膨更低，市場正反映創新帶來的通縮風險，而非經濟崩盤。",
        stocks: ["COIN", "PONY", "KDK", "BEAM"],
        entryPoint: "建議逢低分批佈局如特斯拉等具破壞性創新潛力的科技股，並留意通縮環境下的投資機會。"
    },
    {
...
const twInfluencersData = [
    ...
    },
    {
        ...
        viewpoint: "【2026.07.05 週末最新解析】經搜尋確認，週末期間陳龍並未發布最新的盤勢分析，最新進度停留在週五。目前尚無針對非農數據的最新評論。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "MU (美光)", "2382 (廣達)"],
        entryPoint: "週末無新節目更新，建議投資人先以週五盤後分析為基準，靜待週一開盤後的最新籌碼變化與節目解析。"
    },
    {
        name: "阿村伯",
        style: "存股與生活",
