const usInfluencersData = [
    ...
    },
    {
        name: "美股小左",
        style: "第一視角",
        viewpoint: "【2026.06 週三盤後最新更新】CPI 4.2% 落地！結果：符合預期。小左最新解讀：這是一個「靴子落地但還沒摘鞋」的訊號——通膨確認高檔，但因為「沒有比預期更壞」，市場的極度悲觀情緒可能稍微喘一口氣。🔑 下一個最大的關卡是 6/17 FOMC！新任聯準會主席 Kevin Warsh 的首次決策，才是決定美股方向的真正裁判。若 Warsh 偏鷹（升息暗示）→ 科技股再殺；若偏中性（維持利率不變且不暗示升息）→ 市場將出現較大的軋空反彈。技術面：NVDA 的 30 日均線已跌破，目前在測試 $90 美元的關鍵支撐。今晚美股開盤，密切觀察 NVDA 的量能表現，這是判斷市場情緒是否真正恐慌見底的最佳指標。",
        stocks: ["NVDA (輝達)", "MSFT (微軟)", "META (Meta)"],
        entryPoint: "【盤後更新操作】CPI 落地，下一個大事件是 FOMC（6/17）。今晚觀察 NVDA 在 $90 支撐能否守穩：守穩 → 可試單 10%；若跌破 $85 → 繼續等待，下一個支撐在 $80。FOMC 前維持低倉位。"
    },
    {
        name: "霍比特小灰",
        style: "宏觀與底層邏輯",
