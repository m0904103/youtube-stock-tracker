const usInfluencersData = [
    ...
    },
    {
        name: "Adam Kobeissi",
        style: "數據波段",
        viewpoint: "【2026.06.13 週末結算】SPCX 首日的交易量和期權未平倉量創下了歷史新高！我們觀察到極端的看漲期權偏度，顯示散戶正瘋狂使用槓桿追高。這種資金排擠效應直接導致了部分權值股的失血，不過 NVDA 卻展現強大韌性（收 $205.19）。下週初如果無法守住支撐，可能會引發期權做市商的拋售反噬，加上 6/17 FOMC 的變數，恐引發劇烈震盪。",
    ...
    },
    {
        ...
        style: "迷因價值派",
        viewpoint: "【2026.06.13 週末結算】這是一場史詩級的派對！SPCX 首日表現（收 $160.95）證明了散戶狂熱依舊。這不僅是一檔股票，更是通往火星的單程票。我看到期權市場出現異常的看漲期權買盤，下週 Gamma Squeeze 潛力巨大。鑽石手們，準備好迎接下一波火箭升空了嗎？我們才剛離開地表！",
    ...
    },
    {
        ...
        style: "華爾街名嘴",
        viewpoint: "【2026.06.13 週末結算】聽著，SPCX 是一間偉大的公司，但 176.52 美元的估值已經完全脫離了地球引力！我建議投資人在週末前先獲利了結，把錢拿去買那些因為資金排擠而被錯殺的優質科技股，例如 NVDA（週五逆勢收紅 $205.19）。如果你還沒上車 SPCX，現在千萬別追高，買入被錯殺的股票才是王道！",
        stocks: ["PG", "JNJ", "WM"],
        entryPoint: "【Cramer 反向指標】他喊賣 SPCX 買 NVDA？下週小心 NVDA 補跌，SPCX 繼續飆！"
    },
    {
        name: "美股小左",
        style: "第一視角",
        viewpoint: "【2026.06.13 週末結算】SpaceX 週五的走勢（高達 $176.52 後收 $160.95）完全符合我們盤前推演的突破型態，確立了短線支撐。但資金排擠讓 Nasdaq 跌了 1.42%！下週三的 6/17 FOMC 更是超級大變數，Warsh 的談話風格我們還不熟悉，點陣圖可能會帶來利率預期的重新定價。週末建議把手上獲利較豐厚的部位先做保護性停利。",
    ...
    },
    {
        name: "美股研究社",
        style: "科技股基本面分析",
        viewpoint: "【2026.06.13 週末結算】SpaceX 週五收盤 $160.95，已透支了未來三年的星鏈商業化預期。市場現在完全定價了完美的執行力。然而，Nasdaq 尾盤下挫 1.42% 顯示資金排擠嚴重。下週的 6/17 FOMC 會議將公布點陣圖，若 Warsh 暗示終端利率高於預期，高昂的折現率將嚴重壓縮 SPCX 的合理估值。切勿在宏觀拐點前盲目樂觀。",
        stocks: ["MSFT (微軟)", "AMZN (亞馬遜)", "CRWD (CrowdStrike)"],
        entryPoint: "【週末推演】以 SPCX 首日低點 $149.34 為防守線，重點關注下週 FOMC 點陣圖的長期利率預測。"
    },
    {
        name: "NaNa說美股",
        style: "技術面 & 情緒分析",
...
const twInfluencersData = [
    {
        name: "米哥大白話 (李永年)",
        style: "宏觀警戒 / 貴金屬",
        viewpoint: "【2026.06.13 週末結算】老鐵們，SpaceX 週五這波拉升真的是太猛了（收 $160.95），有膽子跟上的肯定都吃肉了。但聽米哥一句勸，週末高興一下就好，下週三 6/17 FOMC 會議，新主席 Warsh 要公布點陣圖。這種宏觀大事件通常都會把盤面搞得雞飛狗跳。賺錢的先落袋為安，別把辛辛苦苦賺來的利潤在下週三一天全吐回去了。",
    ...
    },
    {
        name: "郭哲榮 (折折)",
        style: "趨勢動能",
        viewpoint: "【2026.06.13 週末結算】各位投資朋友！我早就說過 SpaceX 上市絕對是史詩級行情，你有沒有賺到！週五首日 SPCX 收 $160.95 大漲證明了我的看法完全正確！下週 FOMC 是 Warsh 的第一次登場，大家都在怕點陣圖，但我告訴你，這就是千載難逢的拉回上車機會！不管 Warsh 說什麼，AI 與太空科技的超級大趨勢是不會變的！",
    ...
    },
    {
        name: "股癌 (Gooaye)",
        style: "主觀長期投資",
        viewpoint: "【2026.06.13 週末結算】SpaceX掛牌首日那個動能確實很猛，收盤 $160.95 馬斯克的吸金能力沒話說，但這種 IPO 首日籌碼很亂，沒買到的不用去追高當韭菜。下週 6/17 FOMC 有 Warsh 首秀和點陣圖，老實說市場早就對降息路徑有一定預期，除非點陣圖給出超級意外的指引，不然影響就是幾天的震盪。大家把眼光放長遠。",
    ...
    },
    {
        name: "有心節目",
        style: "籌碼分析 / 期貨追蹤",
        viewpoint: "【2026.06.13 週末結算】SpaceX 週五的強勢表現（大漲 19% 收 $160.95），說明了華爾街對於破壞式創新的追求並未停歇。但別忘了這是在 FOMC 靜默期發生的。下週 Warsh 的新官上任三把火與點陣圖的發布，才是決定美股下半年命運的關鍵。我們推演，Warsh 為建立威信，發言可能偏向保守甚至鷹派，屆時大盤與 SPCX 都可能迎來洗盤。",
    ...
    },
    {
        name: "陳龍 (股市尊龍·運通財經)",
        style: "飆股操作 / 主流輪動",
        viewpoint: "【2026.06.13 週末結算】我早就警告過大家，SpaceX 的上市就是科技股最後的煙火！這種全靠本夢比在炒作的公司，週五衝高到 $176.52 就是主力拉高出貨的套路（Nasdaq 倒跌 1.42% 證明主力在倒貨）！下週 FOMC 會議，Warsh 的點陣圖一定會讓市場大失所望！接下來就是無底洞的崩盤，現在不跑，下週連逃命的機會都沒有！",
