const usInfluencersData = [
    {
        ...
        style: "堅定看多",
        viewpoint: "【2026.06.25 盤後/盤前解析】我們看到標普500目前穩定在 7358 點，那斯達克維持在 25476 點附近。這個點位非常強勢。VIX 降至 17.93 也顯示市場恐慌情緒正在消退。這正是逢低佈局 AI 供應鏈的最佳時機，我們堅定看多。",
        stocks: ["IWM (羅素2000)", "QQQ (納斯達克100)", "SPY (標普500)"],
        entryPoint: "維持滿倉，逢拉回皆是買點。標普 500 7300 點以上皆為強勢整理區間。"
    },
    {
