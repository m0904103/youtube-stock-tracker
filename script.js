const usInfluencersData = [
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】對7月美股樂觀，標普500目標上調至8000點。警告8至10月因IPO解禁與聯準會變數，可能出現「熊市般」劇烈震盪。持續看好科技、小型股與以太幣。",
        stocks: ["IWM (羅素2000)", "QQQ (納斯達克100)", "SPY (標普500)"],
        entryPoint: "把握7月強勢行情偏多操作，但須預先做好避險以應對8至10月的劇烈回檔。"
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】Wilson指出半導體動能消退，資金正轉向微軟、亞馬遜與Meta。他維持標普年底8000點目標，警告晶片股疲軟恐引發震盪，看好非必需消費、生技與運輸受惠資金輪動。",
        stocks: ["MSFT (微軟 ~$410)", "AAPL (蘋果 ~$291)", "GOOGL (Alphabet)"],
        entryPoint: "降低半導體部位，轉進AI雲端巨頭，或佈局非必需消費與生技板塊以因應資金輪動。"
    },
    {
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】指出美國科技業正投入破紀錄的8500億美元於AI資料中心，但警告Meta因缺乏穩定雲端業務且資本支出過高，股票已現拋售跡象；同時強調勞動市場疲軟將引發劇烈波動。",
        stocks: ["TSM (台積電ADR ~$414)", "AMD (超微)", "AVGO (博通 ~$371)"],
        entryPoint: "短期內應對Meta等依賴單一收入卻過度投入AI的科技股保持觀望，並調整部位防範總經波動。"
    },
    {
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】針對今日盤勢，延續「買入破壞性創新」策略，趁大盤回調與特斯拉交車數據後的股價下跌，於今日大幅加倉特斯拉近10萬股與SoFi，對AI相關資產長線依舊看多。",
        stocks: ["COIN", "PONY", "KDK", "BEAM"],
        entryPoint: "善用市場短期的過度反應，逢低買入具備長期顛覆性技術的優質資產。"
    },
    {
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】針對今日盤中表現，指出半導體板塊正在上演「復仇式反彈」。他認為上週市場對晶片股的拋售過於悲觀，特別點名輝達與博通估值已具備吸引力。",
        stocks: ["PG", "JNJ", "WM"],
        entryPoint: "趁市場經歷過度悲觀的拋售後，逢低佈局基本面強勁的AI與半導體龍頭股。"
    },
    {
        name: "美股小左",
        style: "第一視角",
...
const twInfluencersData = [
    {
        ...
        viewpoint: "【2026.07.06 最新解析】台股開高走低，陳智霖認為屬「以盤代跌」洗盤無需悲觀。下週台積電法說會前建議維持中性持股，參與族群輪動。看好封測成波段主流，光通訊逢整理可佈局，並視PCB利空為短期干擾。",
        stocks: ["2330 (台積電)", "2408 (南亞科)", "AI 供應鏈"],
        entryPoint: "台積電法說會前維持中性持股，逢震盪可伺機波段佈局封測與光通訊族群。"
    },
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】早報主題「Token成本下行AI投資出警訊？股價重挫記憶體見頂？」。分析AI算力成本下降對投資版圖的影響，探討記憶體股價大跌是否意味循環見頂，提醒留意風險。",
        stocks: ["0050 (元大台灣50)", "006208 (富邦台50)", "2330 (台積電)", "2382 (廣達)"],
        entryPoint: "面對AI與記憶體族群可能見頂的回調風險，建議投資人審慎評估持股水位，避免盲目追高。"
    },
    {
        name: "楊應超",
        style: "重視估值",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】針對7月6日台股盤中震盪近千點的開高走低格局，拆解導致市場劇烈震盪的關鍵因素，並解析第三季資金輪動方向。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "2317 (鴻海)", "2408 (南亞科)"],
        entryPoint: "避開漲多的AI股，留意具營收支撐的低基期補漲個股，並關注台積電長期價值。"
    },
    {
        name: "胡睿涵 (非凡)",
        style: "價值投資",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】今日盤後解析「輝達驚傳變更設計，台股主流族群易位！」指出輝達相關產品規格調整引發供應鏈股價震盪，促使資金在不同族群間重新輪動，市場主流面臨洗牌。",
        stocks: ["1503 (士電)", "1519 (華城)", "2382 (廣達)", "3231 (緯創)"],
        entryPoint: "切勿盲目追高，建議汰弱留強，鎖定如記憶體等「AI瓶頸族群」，並待籌碼沉澱後再行佈局。"
    },
    {
        name: "賴建承 (非凡)",
        style: "產業基本面",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】台股收跌224點，盤後直播指出開高走低主要受台幣匯率貶值影響，並分析輝達利空傳聞對市場的衝擊，提醒須留意近期匯率與籌碼變化。",
        stocks: ["2408 (南亞科)", "2344 (華邦電)", "3260 (威剛)", "2330 (台積電)"],
        entryPoint: "面對台股因匯率波動造成的開高走低，建議短線保持觀望，靜待台幣止貶與大盤籌碼沉澱後再佈局。"
    },
    {
        name: "優課李霖",
        style: "數據轉折與循環",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】總結台股劇烈震盪失守46600點，點出市場焦點轉向受惠法規解套的軍工無人機概念股，以及外資看多帶動反彈的記憶體族群。",
        stocks: ["2382 (廣達)", "2317 (鴻海)", "2454 (聯發科)"],
        entryPoint: "在台積電進入財報靜默期之際，可留意軍工與記憶體族群的短線輪動機會。"
    },
    {
    ...
    },
    {
        ...
        viewpoint: "【2026.07.06 最新解析】節目針對台股劇烈震盪，指出主因為輝達AI機櫃進度受阻傳聞，拖累軍工、PCB及載板等族群表現，市場資金正觀望台積電法說會。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "MU (美光)", "2382 (廣達)"],
        entryPoint: "避開受輝達利空傳聞干擾之族群，靜待台積電法說會前的法人籌碼動向。"
    },
    {
        name: "阿村伯",
        style: "存股與生活",
