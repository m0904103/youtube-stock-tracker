const usInfluencersData = [
    {
        ...
        style: "堅定看多",
        viewpoint: "【2026.06.16 盤中快報】早盤的下殺完全是洗盤！資金只是在 FOMC 前做短暫的獲利了結，我們看到羅素2000展現了強大的韌性，年底6500點的目標不變。",
        stocks: ["IWM (羅素2000)", "QQQ (納斯達克100)", "SPY (標普500)"],
        entryPoint: "趁早盤恐慌，買進被錯殺的 AI 龍頭。"
    },
    {
        name: "Mike Wilson (Morgan Stanley)",
        style: "務實轉多",
        viewpoint: "【2026.06.16 盤中快報】正如我所警告的，市場開盤後延續了昨晚的『利多出盡』賣壓。高估值的科技股正遭遇資金無情撤出，防禦性板塊是現在唯一的避風港。",
        stocks: ["MSFT (微軟 ~$410)", "AAPL (蘋果 ~$291)", "GOOGL (Alphabet)"],
        entryPoint: "持續降低科技股曝險，買進公用事業與核心消費。"
    },
    {
        name: "Bill Ackman (Pershing Square)",
        style: "價值成長",
        viewpoint: "【2026.06.16 盤中快報】早盤的震盪反映了市場對 Warsh 明天首度發言的焦慮。但我們看到長天期美債殖利率在回落，這對實體經濟是好消息。",
        stocks: ["MSFT (微軟 ~$410)", "META (Meta ~$585)", "AMZN (亞馬遜)"],
        entryPoint: "關注房地產與基建板塊的輪動機會。"
    },
    {
        name: "Ray Dalio (Bridgewater)",
        style: "宏觀避險",
        viewpoint: "【2026.06.16 盤中快報】開盤的劇烈波動證實了當前資金過度集中於單一板塊的風險。在聯準會底牌掀開前，任何單邊押注都極具風險。",
        stocks: ["GLD (黃金)", "TLT (美國長期國債)", "VTI (全市場ETF)"],
        entryPoint: "嚴格執行全天候資產配置，持有黃金。"
    },
    {
        name: "Stanley Druckenmiller",
        style: "宏觀趨勢",
        viewpoint: "【2026.06.16 盤中快報】我不在乎早盤跌了多少，AI 的基礎建設是不可逆的趨勢。Vera晶片的訂單已經排到兩年後，現在的拋售只是短視近利的行為。",
        stocks: ["NVDA (輝達)", "LLY (禮來)", "FCX (自由港麥克莫蘭)"],
        entryPoint: "輝達若回檔至支撐位，就是絕佳買點。"
    },
    {
        name: "Adam Kobeissi",
        style: "數據波段",
        viewpoint: "【2026.06.16 盤中快報】開盤一小時，我們看到 Gamma 轉負後引發的連鎖反應！造市商被迫跟著拋售，SPX 正在測試 5500 點的重要支撐，跌破將引發踩踏！",
        stocks: ["TSM (台積電ADR ~$414)", "AMD (超微)", "AVGO (博通 ~$371)"],
        entryPoint: "嚴格設定停損，跌破支撐可順勢做空。"
    },
    {
        name: "Jensen Huang (黃仁勳)",
        style: "供應鏈狂人",
        viewpoint: "【2026.06.16 盤中快報】股市的波動不會改變運算的未來。我們的供應鏈正在全速運轉，Vera 晶片的需求超乎想像，我們正在建立下一代工業的基礎。",
        stocks: ["NVDA (~$208)", "TSM (~$414)", "ARM"],
        entryPoint: "持有引領第四次工業革命的核心資產。"
    },
    {
        name: "Elon Musk",
        style: "顛覆破壞派",
        viewpoint: "【2026.06.16 盤中快報】SPCX 早盤的波動只是重力異常，我們正在準備下一次的發射。別被華爾街的短期思維綁架，目光放遠點，看向火星！",
        stocks: ["TSLA (~$397)", "GOOGL", "ASTS"],
        entryPoint: "用鑽石手抱緊改變未來的企業。"
    },
    {
        name: "Cathie Wood (ARK木頭姐)",
        style: "破壞性創新",
        viewpoint: "【2026.06.16 盤中快報】創新往往伴隨著極大的波動。早盤資金流出大型科技股，正是給了我們加碼中小型破壞性創新企業的絕佳機會！",
        stocks: ["COIN", "PONY", "KDK", "BEAM"],
        entryPoint: "逢低買入基因編輯與次世代 AI 軟體股。"
    },
    {
        name: "Dan Ives (Wedbush)",
        style: "科技巨頭死忠",
        viewpoint: "【2026.06.16 盤中快報】華爾街現在就像驚弓之鳥。但我們在矽谷看到的依然是狂熱的 AI 軍備競賽，微軟和輝達的基本面堅若磐石，早盤回調就是黃金買點。",
        stocks: ["AAPL (~$291)", "MSFT (~$410)", "AVGO (~$371)"],
        entryPoint: "不要被洗盤嚇跑，用力買進 AI 軟體與晶片股。"
    },
    {
        name: "Keith Gill (Roaring Kitty)",
        style: "迷因價值派",
        viewpoint: "【2026.06.16 盤中快報】早盤這是在演哪一齣？機構想在 FOMC 前把散戶嚇跑？我們不吃這一套！Hold the line！",
        stocks: ["GME (~$22)", "CHWY", "KOSS"],
        entryPoint: "HODL！不要賣出你手中的籌碼！"
    },
    {
        name: "Jim Cramer (瘋狂錢坑)",
        style: "華爾街名嘴",
        viewpoint: "【2026.06.16 盤中快報】天啊！看看早盤的拋售！但我告訴你們，資金正在流向銀行和能源！不要只看著科技股流口水，立刻轉向那些本益比不到15倍的好公司！",
        stocks: ["PG", "JNJ", "WM"],
        entryPoint: "賣出昂貴的科技股，買進傳統藍籌。"
    },
    {
        name: "美股小左",
        style: "第一視角",
        viewpoint: "【2026.06.16 盤中快報】美股開盤後如我們預期出現獲利了結，SPX 留下了向下的跳空缺口。在明天 Warsh 的點陣圖出來前，主力不會有大動作，目前就是量縮震盪。",
        stocks: ["NVDA (輝達 ~$208)", "MSFT (微軟)", "META (Meta)"],
        entryPoint: "多看少做，保留現金等待明晚的 FOMC 決議。"
    },
    {
        name: "霍比特小灰",
        style: "宏觀與底層邏輯",
        viewpoint: "【2026.06.16 盤中快報】早盤的走勢非常黏人。外資昨晚的空單今天開盤有部分回補，但上檔壓力依然沉重。資金明顯在避開科技巨頭，轉向防禦型的高股息標的。",
        stocks: ["TSLA (特斯拉)", "GOOGL (Alphabet)", "NVDA (輝達)"],
        entryPoint: "利用盤中反彈適度減碼，不建議目前抄底。"
    },
    {
        name: "美股研究社",
        style: "科技股基本面分析",
        viewpoint: "【2026.06.16 盤中快報】科技巨頭早盤遭遇逆風，但輝達在 200 元整數關卡展現了強大支撐。這是 FOMC 前的典型部位調整，大戶在壓低進貨，不要輕易交出籌碼。",
        stocks: ["MSFT (微軟)", "AMZN (亞馬遜)", "CRWD (CrowdStrike)"],
        entryPoint: "觀察輝達能否守穩 200 元，守穩則可逢低佈局。"
    },
    {
        name: "NaNa說美股",
        style: "技術面 & 情緒分析",
        viewpoint: "【2026.06.16 盤中快報】哈囉大家！美股開盤跌了一波，大家是不是有點怕怕的？其實這是市場在等明天的聯準會啦！資金現在輪動很快，大家記得繫好安全帶喔！",
        stocks: ["NVDA (輝達)", "MSFT (微軟)", "AAPL (蘋果)"],
        entryPoint: "控制倉位，不要在 FOMC 前夕押注單一方向。"
    },
  {
    name: "Alan Chen",
    style: "裸K與量價分析",
    viewpoint: "【2026.06.16 盤中快報】從開盤第一小時的裸K來看，這根帶量的長黑K確立了短線的頭部型態。多方在 FOMC 前已經棄守，接下來將下探月線支撐，切勿盲目接刀。",
    stocks: ["SPY (標普500)", "QQQ (納斯達克100)", "VIX (恐慌指數)"],
    entryPoint: "跌破頸線，反彈皆是空點，等待月線止跌訊號。"
  }
];
