const usInfluencersData = [
    ...
    },
    {
        ...
        entryPoint: "建議逢低佈局科技、金融、小型股及 AI 基礎建設受惠板塊。"
    },
    {
        name: "Mike Wilson (Morgan Stanley)",
        style: "務實轉多",
        viewpoint: "【2026.07.03 最新解析】Mike Wilson 於 7/2 指出美股漲勢正從熱門科技股擴散至更廣泛板塊。他警告科技股波動加劇，強調市場低估了其他板塊的獲利復甦潛力。",
        stocks: ["MSFT (微軟 ~$410)", "AAPL (蘋果 ~$291)", "GOOGL (Alphabet)"],
        entryPoint: "降低 AI 科技股比重，轉向佈局非必需消費品、運輸及區域型銀行等獲利復甦板塊。"
    },
    {
...
const twInfluencersData = [
    ...
    },
    {
        name: "游庭皓",
        style: "景氣循環",
        viewpoint: "【2026.07.03 最新解析】依據最新觀點，AI投資已正式進入「挑選時代」，不再是閉眼買就能上漲。科技與晶片族群面臨獲利了結壓力，資金正逐漸輪動至傳統板塊。",
        stocks: ["0050 (元大台灣50)", "006208 (富邦台50)", "2330 (台積電)", "2382 (廣達)"],
        entryPoint: "建議停止無腦追高AI概念股，精選具備實質獲利支撐的標的，並適度將資金分散配置。"
    },
    {
        name: "楊應超",
        style: "重視估值",
    ...
    },
    {
        name: "林漢偉 (非凡)",
        style: "資金輪動",
        viewpoint: "【2026.07.03 最新解析】林漢偉指出受美股費半大跌與 AI 資本支出放緩擔憂拖累，電子權值股承壓。外資期貨空單偏空，資金正轉向機器人、軍工與生技等避險題材。",
        stocks: ["1503 (士電)", "1519 (華城)", "2382 (廣達)", "3231 (緯創)"],
        entryPoint: "留意電子權值股止跌訊號並提防中小型股補跌，短線可審慎關注避險題材族群。"
    },
    {
        name: "賴建承 (非凡)",
        style: "產業基本面",
    ...
    },
    {
        name: "郭哲榮 (折折)",
        style: "趨勢動能",
        viewpoint: "【2026.07.03 最新解析】哲哲指出短線急漲2400點後回檔屬正常休息。面對 AI 泡沫疑慮，整體策略維持「拉回就做多」，建議回檔時冷靜尋找優質低基期好股，堅持不開槓桿。",
        stocks: ["2408 (南亞科)", "2344 (華邦電)", "3260 (威剛)", "2330 (台積電)"],
        entryPoint: "秉持「拉回就做多」原則，於回檔時以自有資金布局優質低基期好股。"
    },
    {
        name: "優課李霖",
        style: "數據轉折與循環",
    ...
    },
    {
        name: "股癌 (Gooaye)",
        style: "主觀長期投資",
        viewpoint: "【2026.07.03 最新解析】經查主委於 7/2~7/3 期間並未發布最新短評或限動，內容停留在 7/1。",
        stocks: ["2330 (台積電)", "NVDA (輝達)", "VOO (標普500ETF)"],
        entryPoint: "目前無最新指引，建議先落實 7/1 節目之提醒：管理好盤前情緒，勿隨市場波動自亂陣腳。"
    },
    {
