...
const twInfluencersData = [
    ...
    },
    {
        ...
        entryPoint: "【盤後操作】長線投資者繼續持有，定期定額繼續執行。台積電目前 2,255 元，除息後約 2,249 元。若進一步跌至 2,000 元以下，是超低價的長線買進機會，不要被恐慌蒙蔽眼睛。"
    },
    {
    ...
    },
    {
        ...
        entryPoint: "【盤後操作】等待外資空單回補訊號！若台指期夜盤反彈且空單開始快速減少，明日可小量試單 AI 供應鏈低位階股。台積電今日收 2,255 元（除息前最後日），除息後約 2,249 元，長線布局第一目標位在 2,200 元以下。"
    }
];
