...
const usInfluencersData = [
    {
        ...
        "brierScore": "0.075",
        "ece": "1%",
        "viewpoint": "【2026.08.26 最新】NVDA財報為市場終極催化劑。VIX期限結構顯示避險需求上升但成本相對低廉，期權造市商對沖結構將放大財報後的指數單邊波動。前買權高度集中，做市商Gamma暴露極大。期權隱含波動率(IV)飆升，短天期期權Delta對沖將放大雙向波動，慎防業績落地後IV Crush與Vega修正。翻轉點精確位於$195.86，Call Wall集中於$220。若現貨保持於$195.86上方，造市商Long Gamma將鎖住波動率。",
        "stocks": [
            "NVDA",
            "SPY",
            "QQQ"
    ...
    },
    {
        ...
        "brierScore": "0.088",
        "ece": "2%",
        "viewpoint": "【2026.08.26 最新】警告市場做多NVDA買權（Long Calls）過度擁擠，OPEX後的Gamma斷崖已改變造市商對沖動態，需防範財報發布後波動率重定價帶來的下修風險。與Jackson Hole央行年會共振。指出市場處於極端動量擁擠，做市商倉位將在業績落地後釋放流動性，需慎防回檔引發系統性連鎖去槓桿。壓制效能釋放，造市商動態對沖在財報前夕提供強勁現貨買盤。警惕9月季節性波動率VIX爆發風險。",
        "stocks": [
            "SPX",
            "VIX",
            "NVDA"
...
const twInfluencersData = [
    {
        ...
        "brierScore": "0.110",
        "ece": "3%",
        "viewpoint": "【2026.08.26 盤後】聚焦Blackwell平台成熟放量與下世代Rubin架構過渡節奏；Rubin樣品已交付並預計下半年量產，但需克服HBM4認證、網路升級與液冷散熱等挑戰。擬調漲伺服器15%；台積電CoPoS玻璃基板量產時程落在2027下半年，市場預期有落差，非所有供應鏈均能受惠。，台積電 CoWoS 產能與 ABF 載板良率改善帶動 Blackwell NVL72 量產進度提前；iPhone 18 3nm 晶片備貨強勁。",
        "stocks": [
            "台積電 2330",
            "鴻海 2317",
            "欣興 3037"
    ...
    },
    {
        ...
        "brierScore": "0.125",
        "ece": "4%",
        "viewpoint": "【2026.08.26 盤後】大摩維持台積電為半導體首選，看好CoWoS先進封裝產能擴張；並透過鴻海、廣達等台系ODM出貨動能，正面看待雲端AI長期需求與Token降本趨勢。，台積電先進製程與封裝報價續揚，全球四大CSP資本支出大增帶動台積電積極擴建12座前段廠與4座封裝廠。對台股 AI 伺服器供應鏈「加碼」評等，看好廣達、鴻海與緯創在 GB200 全機櫃出貨帶動下，Q3-Q4 營收將再創歷史新高。",
        "stocks": [
            "廣達 2382",
            "鴻海 2317",
            "緯創 3231"
