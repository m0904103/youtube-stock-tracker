const usInfluencersData = [
    ...
    },
    {
        name: "美股小左",
        style: "第一視角",
        viewpoint: "【2026.06 週三盤前更新】美股週二死貓反彈打臉，那斯達克狂跌 3.5%！台股雖然反彈千點，但美股市場顯示本輪下跌遠未結束。今日 CPI 是最關鍵的催化劑，若通膨再次超預期，科技股將面臨新一輪去槓桿拋售。建議維持低倉位，等待 CPI 落地後再依市場反應決定下一步動作。",
        stocks: ["NVDA (輝達)", "META (Meta)", "TSLA (特斯拉)"],
        entryPoint: "【週三操作】今日以現金為主，CPI 公布後觀察市場反應，若納斯達克當日恢復逾 1.5%，才考慮少量試單 NVDA 與 META。"
    },
    {
        name: "霍比特小灰",
        style: "宏觀與底層邏輯",
