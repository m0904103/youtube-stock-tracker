...
const twInfluencersData = [
    {
        name: "胡睿涵 (非凡錢線百分百)",
        style: "資金流向 / 宏觀總結",
        viewpoint: "【2026.06 非凡追蹤】統整近期外資在期現貨的雙向操作，提醒投資人注意台指期結算前的『外資空單壓盤』風險。大盤在創高後容易引發高檔獲利了結，建議保留現金水位，等待外資買盤回歸大型權值股。",
        stocks: ["2330 (台積電)", "0050 (台灣50)"],
        entryPoint: "觀察外資期貨空單何時退場，等待權值股止跌回穩訊號。"
    },
    {
        name: "林漢偉 (非凡錢線百分百)",
        style: "法人籌碼 / 題材發酵",
        viewpoint: "【2026.06 非凡追蹤】緊盯投信與外資的同買標的。指出目前盤面資金正在進行『高低基期轉換』，從漲多的 AI 伺服器流向落後的蘋概股與車用電子。此外， COMPUTEX 展後的散熱與先進封裝仍是法人短線作帳焦點。",
        stocks: ["3017 (奇鋐)", "3324 (雙鴻)", "2317 (鴻海)"],
        entryPoint: "跟隨投信季底作帳的腳步，買進均線剛多頭排列的散熱族群。"
    },
    {
        name: "賴建承 (非凡錢線百分百)",
        style: "業績選股 / 財報挖寶",
        viewpoint: "【2026.06 非凡追蹤】強調『業績才是王道』，無視短期消息面震盪。特別看好 5 月營收創歷史新高的中小型網通股與 AI 零組件供應商，認為這類公司本益比偏低，有極大的落後補漲空間。",
        stocks: ["2382 (廣達)", "3583 (辛耘)", "6285 (啟碁)"],
        entryPoint: "專注於單月營收雙增 (MoM/YoY) 且法人籌碼尚未發散的低基期黑馬。"
    },
    {
        name: "李兆華 (東森理財達人秀)",
        style: "散戶風向球 / 題材共鳴",
        viewpoint: "【2026.06 東森追蹤】觀察近期散戶熱議焦點，指出市場對高股息 ETF 的狂熱正在退燒，資金開始尋找具有『高息保護加成長性』的標的。呼籲觀眾不要盲目追逐盤中急拉的明牌，應回歸產業基本面，特別是機器人題材的實質受惠股。",
        stocks: ["2359 (所羅門)", "2362 (藍天)", "00929 (復華台灣科技優息)"],
        entryPoint: "避開散戶人踩人的過熱題材，尋找擁有實際 AI 訂單落地的企業。"
    },
    {
        name: "朱家泓 (東森理財達人秀)",
        style: "純技術分析 / 飆股操作",
        viewpoint: "【2026.06 東森追蹤】秉持嚴格的『看圖說故事』紀律。大盤目前處於高檔震盪，個股表現分化。教導觀眾使用『底部帶量突破』與『均線黃金交叉』來抓飆股起漲點，並強調『跌破 5 日線無條件停損』的保命原則。",
        stocks: ["2327 (國巨)", "2449 (京元電子)", "2609 (陽明)"],
        entryPoint: "嚴格遵守技術面停損停利紀律，專做突破前波高點的強勢多頭股。"
    },
    {
        name: "股期龍哥 (東森理財達人秀)",
        style: "期貨籌碼 / 波段操作",
        viewpoint: "【2026.06 東森追蹤】解析莊家選擇權未平倉量 (Put/Call Ratio)，指出目前大盤下檔支撐強勁，但上檔壓力也沉重，屬於『區間盤整偏多』。建議在支撐位附近佈局多單，或利用選擇權進行區間收租策略。",
        stocks: ["台指期貨", "00632R (元大台灣50反1)", "2330 (台積電)"],
        entryPoint: "利用期指支撐壓力位進行高出低進，或以權值股搭配選擇權避險。"
    },
    {
        name: "杜金龍 (下班經濟學)",
        style: "技術分析 / 歷史籌碼",
