...
const twInfluencersData = [
    ...
    },
    {
        name: "游庭皓",
        style: "景氣循環",
        viewpoint: "【2026.06.15 收盤盤後】大家晚安！今天大盤漲1200點，站上4.5萬點。這就是我一直強調的『景氣擴張期主升段』的威力！美伊和平協議讓油價回落、通膨疑慮大減，加上輝達Vera晶片帶來強勁基本面。不要因為短線漲多就想下車，只要景氣對策信號沒有連續亮紅燈，這波多頭我們就是抱緊處理，讓獲利奔跑！",
        stocks: ["0050 (元大台灣50)", "006208 (富邦台50)", "2330 (台積電)", "2382 (廣達)"],
        entryPoint: "順應景氣擴張，堅定抱緊台積電多單與市值型ETF，享受多頭盛宴。"
    },
    {
        name: "楊應超",
        style: "重視估值",
    ...
    },
    {
        name: "陳龍 (股市尊龍·運通財經)",
        style: "飆股操作 / 主流輪動",
        viewpoint: "【2026.06.15 收盤盤後】各位投資朋友！我早就跟你們說我轉多了！你看今天大漲1200點，我叫你們買的台積電是不是噴到2365元！美伊和平協議加上Vera晶片，這盤絕對還會再創歷史新高！不要再跟我提什麼大C波，現在做空就是找死！跟著我全力做多就對了！",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "MU (美光)", "2382 (廣達)"],
        entryPoint: "空頭不死多頭不止！全面看多，拉回就是買進台積電與AI強勢股！"
    },
  {
    name: "Alan Chen",
    style: "具身智能與量化交易",
