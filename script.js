const usInfluencersData = [
    {
        ...
        style: "堅定看多",
        viewpoint: "【2026.06.29 深度解析】Tom Lee 認為近期半導體股回調屬「教科書級別」的週期中段修正，是極佳的買入機會而非崩盤。他強調 2026 年美股上漲由企業獲利驅動，大盤估值比年初更便宜；同時看好加密貨幣為 AI 後續受惠者。",
        stocks: ["IWM (羅素2000)", "QQQ (納斯達克100)", "SPY (標普500)"],
        entryPoint: "可將半導體板塊短期的回調視為逢低買進的機會，並關注由獲利驅動的優質標的。"
    },
    {
        name: "Mike Wilson (Morgan Stanley)",
        style: "務實轉多",
        viewpoint: "【2026.06.29 深度解析】大摩最新報告指出，長期牛市趨勢不變，但受限於流動性緊縮及新任聯準會主席 Kevin Warsh 的政策陣痛期，短期美股將面臨震盪。板塊方面，偏好工業、金融與非必需消費等週期股，並下調醫療保健評級。",
        stocks: ["MSFT (微軟 ~$410)", "AAPL (蘋果 ~$291)", "GOOGL (Alphabet)"],
        entryPoint: "短期操作應避開防禦型的醫療保健板塊，逢低佈局工業與金融等優質週期股以安度震盪期。"
    },
    {
...
const twInfluencersData = [
    ...
    },
    {
        name: "游庭皓",
        style: "景氣循環",
        viewpoint: "【2026.06.29 週末深度解析】游庭皓週末指出，美國半導體管制反而促使中國加速國產化進程，不再單純依賴進口擴廠，轉用國產設備，連日本五大設備商對中銷售也出現歷史首次下滑的警訊。",
        stocks: ["0050 (元大台灣50)", "006208 (富邦台50)", "2330 (台積電)", "2382 (廣達)"],
        entryPoint: "投資人須密切關注中國半導體國產化概念股及全球設備廠的板塊輪動與消長。"
    },
    {
        name: "楊應超",
        style: "重視估值",
    ...
    },
    {
        name: "郭哲榮 (折折)",
        style: "趨勢動能",
        viewpoint: "【2026.06.29 週末深度解析】針對上週五台股暴跌，哲哲稱之為「台股週年慶」，強調恐慌僅是短期籌碼調整，拉回就是買點。他預期一兩週後將恢復大漲，並持續看好 AI 與記憶體族群如環球晶與群聯。",
        stocks: ["2408 (南亞科)", "2344 (華邦電)", "3260 (威剛)", "2330 (台積電)"],
        entryPoint: "拉回即是買點，建議趁「週年慶」大跌時逢低佈局 AI 與記憶體潛力股。"
    },
    {
        name: "優課李霖",
        style: "數據轉折與循環",
    ...
    },
    {
        name: "股癌 (Gooaye)",
        style: "主觀長期投資",
        viewpoint: "【2026.06.29 週末深度解析】股癌 6/27 週末發布 EP674，焦點轉向電動車充電站。他強調對車主而言，站點普及度與操作順暢度比剩餘電量更關鍵，良好的充電體驗為市場真正的剛需。",
        stocks: ["2330 (台積電)", "NVDA (輝達)", "VOO (標普500ETF)"],
        entryPoint: "建議重點關注充電樁設備與基礎設施等相關概念股的佈局機會。"
    },
    {
