const usInfluencersData = [
    ...
    },
    {
        ...
        style: "迷因價值派",
        viewpoint: "【2026.06 週日更新】華爾街正為科技股暴跌哭天喊地，但我依舊神隱。雖然社群極度期待我能在 6 月 7 日兩週年回歸直播，但目前這僅是市場的猜測。不管那斯達克跌多慘，只要散戶團結一致堅持信仰，這波因我而起的波動就還沒結束。我的目光緊盯著 GameStop 等標的，我們能在混亂中找到屬於我們的深層價值。",
        stocks: ["GME", "CHWY", "KOSS"],
        entryPoint: "提防迷因股因預期落空帶來的劇烈震盪，但逢低仍可關注具備軋空潛力的散戶共識股。"
    },
    {
    ...
    },
    {
        name: "美股小左",
        style: "第一視角",
        viewpoint: "【2026.06 災後更新】我先前就不斷警告席勒本益比已經來到 40 倍的歷史高危險區。這次非農數據引爆的拋售，證實了市場對 AI 資本支出能否變現的嚴重質疑。目前大盤還在消化高估值泡沫，真正的底部還沒出現。大家現在最重要的是『保留現金流』，千萬不要急著去逆勢攤平接刀，等待大盤出現明確的止跌訊號再行動。",
        stocks: ["NVDA (輝達)", "META (Meta)", "TSLA (特斯拉)"],
        entryPoint: "多看少做，保留最高現金水位。等待 AI 泡沫質疑聲浪消退與大盤止穩訊號。"
    },
    {
        name: "霍比特小灰",
        style: "宏觀與底層邏輯",
        viewpoint: "【2026.06 災後更新】這次的股災印證了我們對『宏觀流動性收緊』與『市場分化』的預判。未來的行情將從 AI 的『芯片層』逐漸轉移到『落地應用層』。大家必須注意，後續像 SpaceX 這類超級巨頭的 IPO，可能會像是『市場大殺器』一樣吸走科技股的流動性。現在要回歸底層邏輯，只投資有真實獲利護城河的企業，拋棄純炒作的標的。",
        stocks: ["TSLA (特斯拉)", "GOOGL (Alphabet)", "NVDA (輝達)"],
        entryPoint: "關注宏觀流動性變化，將資金從純芯片硬體轉向具有實質應用落地的 AI 企業。"
    }
];
...
const twInfluencersData = [
    ...
    },
    {
        name: "杜金龍 (下班經濟學)",
        style: "波浪理論",
        viewpoint: "【2026.06 災後更新】台股進入主升段的長期多頭架構未變，長線有機會挑戰 47,000 點甚至更高！這波急殺清理了過熱籌碼，屬於中級修正。投資人應關注『兆元成交量』的過熱警訊，並緊盯台積電、聯發科等領頭羊。操作上可採取『右下角選股術』，趁大盤震盪挑選跌破淨值的價值股與具轉機題材的記憶體族群，穩穩抱住優質權值股。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "2317 (鴻海)", "2408 (南亞科)"],
        entryPoint: "觀察集中市場與櫃買合計成交量是否達兆元警戒，運用右下角選股術逢低布局權值股。"
    },
    {
        name: "胡睿涵 (非凡)",
        style: "價值投資",
    ...
    },
    {
        name: "錢線百分百 (非凡財經)",
        style: "總經與大盤解析",
        viewpoint: "【2026.06 災後特別報導】面對史上最大單日跌幅，錢線百分百多位來賓達成共識：這波是多頭總修正，主要來自日圓套利平倉與美股科技股財報不如預期。恐慌指數VIX雖飆高，但AI長線基本面未變。短線大盤需觀察半年線支撐與融資減肥狀況。切忌盲目摸底，保留現金，待量縮止跌、權值股（如台積電、聯發科）不再破底後，才是中長線投資人進場的好時機。",
        stocks: ["2330 (台積電)", "2454 (聯發科)", "2317 (鴻海)", "2382 (廣達)"],
        entryPoint: "觀察半年線支撐與融資減肥，待權值股不再破底、爆量收下影線時再分批進場。"
    },
    {
        name: "郭哲榮 (折折)",
        style: "趨勢動能",
        viewpoint: "【2026.06 災後更新】我之前就說過台股有回檔風險，不排除跌幅達到六千點！這次千點下殺、多殺多的恐慌盤已經應驗我的預警。大家千萬不要『無腦多』去接刀！雖然長線看好 AI 與 HBM（高頻寬記憶體）的產能排擠效應，但現在一定要嚴守紀律。以技術線型為進出依據，保留現金，等恐慌落底後再布局有爆發力的記憶體族群。",
        stocks: ["2408 (南亞科)", "2344 (華邦電)", "3260 (威剛)", "2330 (台積電)"],
        entryPoint: "嚴格執行停損停利，不無腦接刀。待技術線型止穩後，再進場布局受惠於 HBM 排擠效應的記憶體族群。"
    },
    {
        name: "優課李霖",
        style: "數據轉折與循環",
        viewpoint: "【2026.06 災後更新】這次股災完全印證了我們事前針對『宏觀數據轉折』與『市場高點循環』的警告。通膨壓力、能源價格與科技股信心動搖，是這波劇烈修正的主因。接下來市場將面臨 6 月中旬聯準會 (FOMC) 會議及四巫日結算的雙重變數。請嚴格控管資金與槓桿風險，切忌在恐慌中盲目殺低，但也絕不可隨意接刀，避免將資金重壓單一題材。",
        stocks: ["2330 (台積電)", "2317 (鴻海)", "0050 (元大台灣50)"],
        entryPoint: "嚴格控管資金與槓桿，靜待 FOMC 會議與四巫日變數釐清後再行動作。"
    }
];
