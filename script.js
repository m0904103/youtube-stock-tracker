const usInfluencersData = [
    ...
    },
    {
        ...
        viewpoint: "【2026.07.05 週末最新解析】Tom Lee 針對疲軟非農數據表示，儘管市場可能面臨 15-20% 回調，但牛市基礎依舊穩固。Fundstrat 將標普年底目標價上調至 8000 點，持續看多。",
        stocks: ["IWM (羅素2000)", "QQQ (納斯達克100)", "SPY (標普500)"],
        entryPoint: "面對非農數據引發的潛在波動，建議保留資金彈性，伺機在回調時逢低佈局科技與小型股。"
    },
    {
        ...
        viewpoint: "【2026.07.05 週末最新解析】目前尚未發布全新報告，但他近期強烈警告科技與半導體動能已達歷史極端，面臨耗盡與震盪風險，並指出美股正進入廣泛的輪動階段。",
        stocks: ["MSFT (微軟 ~$410)", "AAPL (蘋果 ~$291)", "GOOGL (Alphabet)"],
        entryPoint: "建議降低高動能科技股曝險，將資金輪動至可選消費、運輸與區域銀行等循環性板塊。"
    },
    {
...
const twInfluencersData = [
...

    {
        ...
        viewpoint: "【2026.07.05 週末最新解析】週末暫無更新，最新為7/3盤後指出傳產股撐盤，並看好記憶體族群黑翻紅轉折，但提醒大盤仍須居高思危。",
        stocks: ["GLD (黃金)", "SLV (白銀)", "XLE (能源ETF)", "2330 (台積電)"],
        entryPoint: "大盤高檔震盪，建議維持少量操作，採取「低進高出」的短線策略。"
    },
    {
        name: "谷月涵",
        style: "防禦保守",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.05 週末最新解析】游庭皓指出 6 月非農數據爆冷，但市場出現反差，道瓊創高且黃金受追捧。他提醒 AI 投資已進入看重實質獲利的「挑選時代」。",
        stocks: ["0050 (元大台灣50)", "006208 (富邦台50)", "2330 (台積電)", "2382 (廣達)"],
        entryPoint: "投資人不應只看單一數據，應綜合非農、CPI與聯準會政策推演下半年配置，嚴格篩選 AI 標的。"
    },
    {
        name: "楊應超",
        style: "重視估值",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.05 週末最新解析】非農低於預期引發衰退疑慮。林漢偉指出，受費半重挫與外資偏空拖累，台股面臨回檔壓力並持續測試月線支撐，須嚴防中小型股高檔補跌與權值股後續止跌訊號。",
        stocks: ["1503 (士電)", "1519 (華城)", "2382 (廣達)", "3231 (緯創)"],
        entryPoint: "反彈時切忌盲目追高，請落實汰弱留強，逢低佈局具基本面支撐的AI瓶頸族群與防禦型個股。"
    },
    {
        name: "賴建承 (非凡)",
        style: "產業基本面",
    ...
    },
    {
        ...
        viewpoint: "【2026.07.05 週末最新解析】最新非農僅增5.7萬人遠低預期，有利寬鬆氣氛。折折指出台股近期震盪及外資空單屬正價差套利的正常現象。7/16台積電法說將是續攻關鍵，大盤沉澱後有望再衝刺。",
        stocks: ["2408 (南亞科)", "2344 (華邦電)", "3260 (威剛)", "2330 (台積電)"],
        entryPoint: "多頭格局切勿逆勢做空，建議逢低佈局低基期優質股，並靜待台積電法說會帶動的下一波攻勢。"
    },
    {
        name: "優課李霖",
        style: "數據轉折與循環",
